...
export const INITIAL_BANNERS: Banner[] = [
  {
    id: 'banner-new-001',
    imageUrl: 'https://storage.googleapis.com/aistudio-hosting/workspace-assets/5f38a53a-c854-448f-9d32-d820f4c33f27',
  },
  {
    id: 'banner-001',
...
export const INITIAL_SITE_INFO: SiteInfo = {
  siteName: 'DDHOUSE by Bandd789',
  siteTagline: 'ศูนย์รับสร้างบ้าน บ้านดีดีวิศวกรรม',
  logoUrl: '',
  phone: '02 938 3456',
  socials: {
