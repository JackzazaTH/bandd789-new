...
<p>เราจะไม่เปิดเผยข้อมูลส่วนบุคคลของท่านแก่บุคคลภายนอกโดยไม่ได้รับความยินยอมจากท่าน เว้นแต่จะเป็นไปตามที่กฎหมายกำหนด</p>`,
  ...
  },
  {
    ...
    <div class="max-w-6xl mx-auto mb-16 px-4">
        ...
        <!-- Simplified Responsive Grid for Steps -->
        <div class="grid grid-cols-2 md:grid-cols-5 gap-y-8 gap-x-4 relative">
             
            <!-- Step 1 -->
            <div class="flex flex-col items-center text-center">
                <div class="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-3 shadow-md">01</div>
                <div class="bg-red-50 p-3 rounded-full mb-2"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg></div>
                <p class="text-sm font-bold text-gray-800">เลือกแบบบ้าน</p>
            </div>

            <!-- Step 2 -->
            <div class="flex flex-col items-center text-center">
                <div class="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-3 shadow-md">02</div>
                ...
                <p class="text-sm font-bold text-gray-800">ชำระเงินจอง<br/>สำรวจที่ดิน</p>
            </div>

            <!-- Step 3 -->
             <div class="flex flex-col items-center text-center">
                <div class="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-3 shadow-md">03</div>
                <div class="bg-red-50 p-3 rounded-full mb-2"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg></div>
                <p class="text-sm font-bold text-gray-800">เขียนแบบ<br/>ทำสัญญา</p>
            </div>

            <!-- Step 4 -->
             <div class="flex flex-col items-center text-center">
                <div class="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-3 shadow-md">04</div>
                <div class="bg-red-50 p-3 rounded-full mb-2"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg></div>
                <p class="text-sm font-bold text-gray-800">เตรียมเอกสาร<br/>ยื่นขออนุญาต</p>
            </div>

            <!-- Step 5 -->
             <div class="flex flex-col items-center text-center">
                <div class="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-3 shadow-md">05</div>
                <div class="bg-red-50 p-3 rounded-full mb-2"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg></div>
                <p class="text-sm font-bold text-gray-800">เริ่มงานก่อสร้าง</p>
            </div>

            <!-- Step 6 -->
             <div class="flex flex-col items-center text-center">
                <div class="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-3 shadow-md">10</div>
                <div class="bg-red-50 p-3 rounded-full mb-2"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg></div>
                <p class="text-sm font-bold text-gray-800">รับประกัน<br/>บริการหลังขาย</p>
            </div>

            <!-- Step 7 -->
             <div class="flex flex-col items-center text-center">
                <div class="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-3 shadow-md">09</div>
                <div class="bg-red-50 p-3 rounded-full mb-2"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg></div>
                <p class="text-sm font-bold text-gray-800">ส่งมอบบ้าน</p>
            </div>

            <!-- Step 8 -->
             <div class="flex flex-col items-center text-center">
                <div class="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-3 shadow-md">08</div>
                <div class="bg-red-50 p-3 rounded-full mb-2"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" /></svg></div>
                <p class="text-sm font-bold text-gray-800">บริการขอเลขที่บ้าน<br/>และมิเตอร์ถาวร</p>
            </div>

            <!-- Step 9 -->
             <div class="flex flex-col items-center text-center">
                <div class="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-3 shadow-md">07</div>
                <div class="bg-red-50 p-3 rounded-full mb-2"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" /></svg></div>
                <p class="text-sm font-bold text-gray-800">ชำระเงินงวดงาน<br/>ตามสัญญา</p>
            </div>
            
            <!-- Step 10 -->
             <div class="flex flex-col items-center text-center">
                <div class="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-3 shadow-md">06</div>
                <div class="bg-red-50 p-3 rounded-full mb-2"><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg></div>
                <p class="text-sm font-bold text-gray-800">ขอมิเตอร์<br/>น้ำ-ไฟ ชั่วคราว</p>
            </div>
        </div>
    </div>

    <!-- Title Banner -->
    <div class="bg-primary text-white text-center py-6 md:py-8 rounded-lg shadow-lg mb-12 relative overflow-hidden mx-4">
        <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-red-900 to-transparent opacity-30"></div>
        <h2 class="text-3xl md:text-4xl font-bold relative z-10 drop-shadow-md">ขั้นตอนการปลูกสร้างบ้าน</h2>
        <p class="text-red-100 mt-2 relative z-10">DDHOUSE บริการเหนือระดับ สร้างบ้านคุณภาพ</p>
    </div>

    <!-- Quote Section -->
    <div class="text-center mb-12 px-4">
        <p class="text-gray-500 text-lg">ด้วยการให้บริการครบวงจรแบบ</p>
        <div class="flex items-center justify-center gap-4 my-4">
             <svg class="w-8 h-8 text-primary opacity-50 transform rotate-180" fill="currentColor" viewBox="0 0 24 24"><path d="M14.017 21L14.017 18C14.017 16.054 15.825 14.618 17.317 14.757C17.463 13.027 15.545 11.337 13.513 10.571L13.513 6.627C13.513 3.483 16.419 1.00001 19.639 1.00001L20.529 1.00001C21.81 1.00001 22.952 1.99801 23.008 3.32801L23.008 21L14.017 21ZM5.002 21L5.002 18C5.002 16.054 6.828 14.618 8.321 14.757C8.467 13.027 6.55 11.337 4.518 10.571L4.518 6.627C4.518 3.483 7.424 1.00001 10.644 1.00001L11.534 1.00001C12.815 1.00001 13.957 1.99801 14.013 3.32801L14.013 21L5.002 21Z"></path></svg>
             <h3 class="text-3xl md:text-4xl font-bold text-gray-800">One Stop Service</h3>
             <svg class="w-8 h-8 text-primary opacity-50" fill="currentColor" viewBox="0 0 24 24"><path d="M14.017 21L14.017 18C14.017 16.054 15.825 14.618 17.317 14.757C17.463 13.027 15.545 11.337 13.513 10.571L13.513 6.627C13.513 3.483 16.419 1.00001 19.639 1.00001L20.529 1.00001C21.81 1.00001 22.952 1.99801 23.008 3.32801L23.008 21L14.017 21ZM5.002 21L5.002 18C5.002 16.054 6.828 14.618 8.321 14.757C8.467 13.027 6.55 11.337 4.518 10.571L4.518 6.627C4.518 3.483 7.424 1.00001 10.644 1.00001L11.534 1.00001C12.815 1.00001 13.957 1.99801 14.013 3.32801L14.013 21L5.002 21Z"></path></svg>
        </div>
        <p class="text-lg font-medium text-gray-600">ทำให้การสร้างบ้านของคุณเป็นเรื่องง่าย</p>
    </div>
    ...
    <div class="max-w-4xl mx-auto space-y-4 px-4">
        ...
        <details class="group bg-white rounded-xl shadow-sm border border-gray-200 open:shadow-md transition-all duration-300 open:bg-red-50/30" open>
            <summary class="flex items-center justify-between cursor-pointer p-6 list-none">
                <h3 class="text-xl font-bold text-primary">เตรียมความพร้อมก่อนปลูกสร้าง</h3>
            ...
            <div class="px-6 pb-6 text-gray-600 leading-relaxed animate-fade-in">
        ...
        <details class="group bg-white rounded-xl shadow-sm border border-gray-200 open:shadow-md transition-all duration-300 open:bg-red-50/30">
            <summary class="flex items-center justify-between cursor-pointer p-6 list-none">
                <h3 class="text-xl font-bold text-primary">งานเสาเข็ม</h3>
                <span class="transition-transform duration-300 group-open:rotate-180 text-primary">
                     <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                </span>
            </summary>
        ...
        <details class="group bg-white rounded-xl shadow-sm border border-gray-200 open:shadow-md transition-all duration-300 open:bg-red-50/30">
            <summary class="flex items-center justify-between cursor-pointer p-6 list-none">
                <h3 class="text-xl font-bold text-primary">งานโครงสร้าง</h3>
                <span class="transition-transform duration-300 group-open:rotate-180 text-primary">
                     <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                </span>
            </summary>
        ...
        <details class="group bg-white rounded-xl shadow-sm border border-gray-200 open:shadow-md transition-all duration-300 open:bg-red-50/30">
            <summary class="flex items-center justify-between cursor-pointer p-6 list-none">
                <h3 class="text-xl font-bold text-primary">งานสถาปัตยกรรมและงานระบบ</h3>
                <span class="transition-transform duration-300 group-open:rotate-180 text-primary">
                     <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                </span>
            </summary>
        ...
        <details class="group bg-white rounded-xl shadow-sm border border-gray-200 open:shadow-md transition-all duration-300 open:bg-red-50/30">
            <summary class="flex items-center justify-between cursor-pointer p-6 list-none">
                <h3 class="text-xl font-bold text-primary">การเก็บงานพร้อมส่งมอบบ้าน</h3>
                <span class="transition-transform duration-300 group-open:rotate-180 text-primary">
                     <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                </span>
            </summary>
  ...
  },
  {
    ...
    <div class="text-center max-w-4xl mx-auto mb-12">
        <h2 class="text-3xl md:text-4xl font-bold text-primary mb-4">คัดสรรสิ่งที่ดีที่สุดเพื่อบ้านคุณ</h2>
        <p class="text-lg text-gray-600">มาตรฐานวัสดุเกรดพรีเมียม มั่นใจได้ในความแข็งแรง ทนทาน และสวยงาม</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 group">
            <div class="bg-gray-50 p-6 border-b border-gray-100 flex items-center gap-4 group-hover:bg-primary/5 transition-colors">
                ...
                <h3 class="font-bold text-gray-800 text-lg">งานโครงสร้าง</h3>
            </div>
            <div class="p-6">
                <ul class="space-y-4">
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="flex items-center justify-center w-5 h-5 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-xs">✓</span>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 group">
            <div class="bg-gray-50 p-6 border-b border-gray-100 flex items-center gap-4 group-hover:bg-primary/5 transition-colors">
                ...
                <h3 class="font-bold text-gray-800 text-lg">งานหลังคา</h3>
            </div>
            <div class="p-6">
                <ul class="space-y-4">
                    <li class="flex items-start gap-3 text-sm text-gray-600">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 group">
            <div class="bg-gray-50 p-6 border-b border-gray-100 flex items-center gap-4 group-hover:bg-primary/5 transition-colors">
                ...
                <h3 class="font-bold text-gray-800 text-lg">งานผนัง</h3>
            </div>
            <div class="p-6">
                <ul class="space-y-4">
                    <li class="flex items-start gap-3 text-sm text-gray-600">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 group">
            <div class="bg-gray-50 p-6 border-b border-gray-100 flex items-center gap-4 group-hover:bg-primary/5 transition-colors">
                ...
                <h3 class="font-bold text-gray-800 text-lg">งานพื้น</h3>
            </div>
            <div class="p-6">
                <ul class="space-y-4">
                    <li class="flex items-start gap-3 text-sm text-gray-600">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 group">
            <div class="bg-gray-50 p-6 border-b border-gray-100 flex items-center gap-4 group-hover:bg-primary/5 transition-colors">
                ...
                <h3 class="font-bold text-gray-800 text-lg">ประตูหน้าต่าง</h3>
            </div>
            <div class="p-6">
                <ul class="space-y-4">
                    <li class="flex items-start gap-3 text-sm text-gray-600">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 group">
            <div class="bg-gray-50 p-6 border-b border-gray-100 flex items-center gap-4 group-hover:bg-primary/5 transition-colors">
                ...
                <h3 class="font-bold text-gray-800 text-lg">งานระบบ</h3>
            </div>
            <div class="p-6">
                <ul class="space-y-4">
                    <li class="flex items-start gap-3 text-sm text-gray-600">
    ...
    <!-- Warranty Box -->
    <div class="mt-16 max-w-5xl mx-auto bg-primary rounded-2xl p-10 text-white shadow-2xl relative overflow-hidden">
        ...
        <div class="relative z-10 text-center md:text-left">
            <div class="flex flex-col md:flex-row items-center md:items-start justify-between mb-8">
                <div>
                    <h3 class="text-2xl md:text-3xl font-bold mb-2">การรับประกันคุณภาพ</h3>
                    <p class="text-red-100">เรามั่นใจในคุณภาพงานก่อสร้าง ด้วยการรับประกันที่คุณวางใจได้</p>
                </div>
                <div class="mt-4 md:mt-0 bg-white/10 backdrop-blur-md px-4 py-2 rounded-lg border border-white/20">
                    <span class="text-sm font-medium">DDHOUSE Warranty</span>
                </div>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white/10 rounded-xl p-6 flex flex-col items-center md:items-start hover:bg-white/20 transition-colors">
                    <div className="text-4xl font-bold text-yellow-400 mb-1">20 ปี</div>
                    <div className="text-lg font-medium">รับประกันโครงสร้าง</div>
                    <p className="text-sm text-white/70 mt-1 text-center md:text-left">เสาเข็ม ฐานราก คาน เสา พื้น</p>
                </div>
                <div className="bg-white/10 rounded-xl p-6 flex flex-col items-center md:items-start hover:bg-white/20 transition-colors">
                     <div className="text-4xl font-bold text-yellow-400 mb-1">5 ปี</div>
                    <div className="text-lg font-medium">รับประกันงานหลังคา</div>
                    <p className="text-sm text-white/70 mt-1 text-center md:text-left">การรั่วซึมของหลังคาและดาดฟ้า</p>
                </div>
                 <div className="bg-white/10 rounded-xl p-6 flex flex-col items-center md:items-start hover:bg-white/20 transition-colors">
                     <div className="text-4xl font-bold text-yellow-400 mb-1">1 ปี</div>
                    <div className="text-lg font-medium">รับประกันงานสถาปัตย์</div>
                     <p className="text-sm text-white/70 mt-1 text-center md:text-left">งานพื้น ผนัง ฝ้า และสี</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-5xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group border border-gray-100">
                <div class="h-64 bg-gray-50 flex items-center justify-center group-hover:bg-primary/5 transition-colors relative">
                     <div class="absolute top-4 right-4 opacity-10 group-hover:opacity-20 transition-opacity">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h6m-6 4h6m-6 4h6" /></svg>
                     </div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-20 w-20 text-primary opacity-90 group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h6m-6 4h6m-6 4h6" /></svg>
                </div>
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-bold text-gray-800 mb-4 group-hover:text-primary transition-colors">ตกแต่งภายใน (Interior)</h3>
                    <p class="text-gray-600 leading-relaxed">เนรมิตพื้นที่ใช้สอยให้สวยงามลงตัว ด้วยทีมมัณฑนากรมากประสบการณ์ ตอบโจทย์ทุกไลฟ์สไตล์ พร้อมงานบิ้วอินคุณภาพสูง</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group border border-gray-100">
                <div class="h-64 bg-gray-50 flex items-center justify-center group-hover:bg-primary/5 transition-colors relative">
                     <div class="absolute top-4 right-4 opacity-10 group-hover:opacity-20 transition-opacity">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>
                     </div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-20 w-20 text-primary opacity-90 group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>
                </div>
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-bold text-gray-800 mb-4 group-hover:text-primary transition-colors">สระว่ายน้ำ (Swimming Pool)</h3>
                    <p class="text-gray-600 leading-relaxed">บริการออกแบบและก่อสร้างสระว่ายน้ำระบบเกลือ ระบบน้ำล้น พร้อมจากุซซี่และสปา ในราคาที่คุณจับต้องได้</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group border border-gray-100">
                 <div class="h-64 bg-gray-50 flex items-center justify-center group-hover:bg-primary/5 transition-colors relative">
                     <div class="absolute top-4 right-4 opacity-10 group-hover:opacity-20 transition-opacity">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6H8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9" /></svg>
                     </div>
                ...
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-bold text-gray-800 mb-4 group-hover:text-primary transition-colors">จัดสวน (Landscape)</h3>
                    <p class="text-gray-600 leading-relaxed">เปลี่ยนพื้นที่รอบบ้านให้เป็นสวนสวย ร่มรื่น เพิ่มพื้นที่สีเขียวและมุมพักผ่อนให้คนในครอบครัว ด้วยดีไซน์ที่ทันสมัย</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group border border-gray-100">
                 <div class="h-64 bg-gray-50 flex items-center justify-center group-hover:bg-primary/5 transition-colors relative">
                     <div class="absolute top-4 right-4 opacity-10 group-hover:opacity-20 transition-opacity">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                     </div>
                ...
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-bold text-gray-800 mb-4 group-hover:text-primary transition-colors">สมาร์ทโฮม (Smart Home)</h3>
                    <p class="text-gray-600 leading-relaxed">ยกระดับความสะดวกสบายและความปลอดภัย ด้วยระบบบ้านอัจฉริยะ ควบคุมไฟ แอร์ และกล้องวงจรปิดผ่านมือถือ</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group border border-gray-100">
                ...
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-bold text-gray-800 mb-4 group-hover:text-primary transition-colors">รั้วและประตู (Gate & Fence)</h3>
                    <p class="text-gray-600 leading-relaxed">ออกแบบและติดตั้งรั้วรอบบ้าน ประตูรั้วรีโมท อลูมิเนียมลายไม้ หรือเหล็กดัด สวยงาม ทนทาน เข้ากับตัวบ้าน</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group border border-gray-100">
                <div class="h-64 bg-gray-50 flex items-center justify-center group-hover:bg-primary/5 transition-colors relative">
                     <div class="absolute top-4 right-4 opacity-10 group-hover:opacity-20 transition-opacity">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                     </div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-20 w-20 text-primary opacity-90 group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                </div>
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-bold text-gray-800 mb-4 group-hover:text-primary transition-colors">ขอมิเตอร์ (Meters)</h3>
                    <p class="text-gray-600 leading-relaxed">บริการยื่นเรื่องขอติดตั้งมิเตอร์ประปาและไฟฟ้าถาวร เดินเรื่องเอกสารราชการให้ครบถ้วน พร้อมใช้งานก่อนเข้าอยู่</p>
                </div>
            </div>
        </div>
    </div>
