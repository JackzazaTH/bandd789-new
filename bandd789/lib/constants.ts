...
<p>เราจะไม่เปิดเผยข้อมูลส่วนบุคคลของท่านแก่บุคคลภายนอกโดยไม่ได้รับความยินยอมจากท่าน เว้นแต่จะเป็นไปตามที่กฎหมายกำหนด</p>`,
  ...
  },
  {
    ...
    <div class="text-center max-w-3xl mx-auto mb-12">
        <h2 class="text-3xl md:text-4xl font-bold text-primary mb-4">เส้นทางสู่บ้านในฝัน</h2>
        <p class="text-lg text-gray-600">ขั้นตอนการทำงานที่เป็นระบบ โปร่งใส และตรวจสอบได้ทุกขั้นตอน</p>
    </div>

    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        <!-- Step 1 -->
        <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 relative group overflow-hidden">
            <div class="absolute top-0 right-0 bg-gray-50 px-4 py-2 rounded-bl-2xl text-2xl font-bold text-gray-200 group-hover:text-primary/20 transition-colors">01</div>
            <div class="w-16 h-16 bg-red-50 rounded-2xl flex items-center justify-center mb-6 text-primary group-hover:scale-110 transition-transform duration-300 shadow-sm">
            ...
            <p class="text-gray-600 text-sm leading-relaxed">ลงพื้นที่จริง สำรวจทิศทางลม-แดด วิเคราะห์ความต้องการ และวางแผนงบประมาณเพื่อการออกแบบที่ลงตัว</p>
        </div>

        <!-- Step 2 -->
        <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 relative group overflow-hidden">
             <div class="absolute top-0 right-0 bg-gray-50 px-4 py-2 rounded-bl-2xl text-2xl font-bold text-gray-200 group-hover:text-primary/20 transition-colors">02</div>
            <div class="w-16 h-16 bg-red-50 rounded-2xl flex items-center justify-center mb-6 text-primary group-hover:scale-110 transition-transform duration-300 shadow-sm">
            ...
            <p class="text-gray-600 text-sm leading-relaxed">สรุปแบบก่อสร้าง เสนอราคา (BOQ) ทำสัญญา และดำเนินการยื่นขออนุญาตปลูกสร้างกับราชการ</p>
        </div>

        <!-- Step 3 -->
        <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 relative group overflow-hidden">
             <div class="absolute top-0 right-0 bg-gray-50 px-4 py-2 rounded-bl-2xl text-2xl font-bold text-gray-200 group-hover:text-primary/20 transition-colors">03</div>
            <div class="w-16 h-16 bg-red-50 rounded-2xl flex items-center justify-center mb-6 text-primary group-hover:scale-110 transition-transform duration-300 shadow-sm">
            ...
            <h3 class="text-xl font-bold text-gray-800 mb-3">งานโครงสร้าง</h3>
            <p class="text-gray-600 text-sm leading-relaxed">ตอกเสาเข็ม หล่อฐานราก คาน และเสา ควบคุมโดยวิศวกรเพื่อความมั่นคงแข็งแรงตามหลักวิศวกรรม</p>
        </div>

        <!-- Step 4 -->
        <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 relative group overflow-hidden">
             <div class="absolute top-0 right-0 bg-gray-50 px-4 py-2 rounded-bl-2xl text-2xl font-bold text-gray-200 group-hover:text-primary/20 transition-colors">04</div>
            <div class="w-16 h-16 bg-red-50 rounded-2xl flex items-center justify-center mb-6 text-primary group-hover:scale-110 transition-transform duration-300 shadow-sm">
               <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg>
            </div>
            <h3 class="text-xl font-bold text-gray-800 mb-3">งานสถาปัตยกรรม</h3>
            <p class="text-gray-600 text-sm leading-relaxed">มุงหลังคา ก่อผนัง ฉาบปูน ติดตั้งประตูหน้าต่าง ให้บ้านเป็นรูปเป็นร่างสวยงามตามแบบ</p>
        </div>

        <!-- Step 5 -->
        <div class="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300 relative group overflow-hidden">
             <div class="absolute top-0 right-0 bg-gray-50 px-4 py-2 rounded-bl-2xl text-2xl font-bold text-gray-200 group-hover:text-primary/20 transition-colors">05</div>
            <div class="w-16 h-16 bg-red-50 rounded-2xl flex items-center justify-center mb-6 text-primary group-hover:scale-110 transition-transform duration-300 shadow-sm">
            ...
            <p class="text-gray-600 text-sm leading-relaxed">ติดตั้งระบบไฟฟ้า ประปา สุขาภิบาล ปูกระเบื้อง ทาสี และเก็บรายละเอียดความเรียบร้อย</p>
        </div>

        <!-- Step 6 -->
        <div class="bg-gradient-to-br from-primary to-red-800 rounded-2xl p-8 shadow-lg relative overflow-hidden group hover:shadow-xl transition-all duration-300">
             <div class="absolute top-0 right-0 bg-white/10 px-4 py-2 rounded-bl-2xl text-2xl font-bold text-white/30">06</div>
            <div class="w-16 h-16 bg-white text-primary rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-md">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
            </div>
            <h3 class="text-xl font-bold text-white mb-3">ตรวจสอบและส่งมอบ</h3>
            <p class="text-red-100 text-sm leading-relaxed">QC ตรวจสอบคุณภาพครั้งสุดท้าย ทำความสะอาด Big Cleaning และส่งมอบบ้านพร้อมรับประกัน</p>
        </div>
    </div>
</div>`,
  ...
  },
  {
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            <div class="bg-gray-50 p-5 border-b border-gray-100 flex items-center gap-4">
                <div class="p-2.5 bg-white rounded-lg shadow-sm text-primary">
            ...
            <div class="p-6">
                <ul class="space-y-3">
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        ...
                        <span><strong>เสาเข็ม:</strong> มาตรฐานวิศวกรรม ตอกถึงชั้นดินดาน</span>
                    </li>
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>คอนกรีต:</strong> CPAC/Namheng 240 KSC แข็งแรง</span>
                    </li>
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>เหล็กเส้น:</strong> มอก. โรงใหญ่ เต็มน้ำหนัก</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            ...
            <div class="p-6">
                <ul class="space-y-3">
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>โครงหลังคา:</strong> โครงถักสำเร็จรูป/เหล็กกันสนิม</span>
                    </li>
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>กระเบื้อง:</strong> SCG รุ่น Prestige/Excella</span>
                    </li>
                     <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>ฉนวน:</strong> แผ่นสะท้อนความร้อนใต้หลังคา</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            ...
            <div class="p-6">
                <ul class="space-y-3">
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>อิฐ:</strong> มวลเบา Q-CON G4 เย็นและเงียบ</span>
                    </li>
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>งานฉาบ:</strong> ปูนสำเร็จรูป เสริมลวดกรงไก่</span>
                    </li>
                     <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>สี:</strong> TOA 4 Seasons/Supershield</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            ...
            <div class="p-6">
                <ul class="space-y-3">
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>ชั้นล่าง:</strong> แกรนิตโต้ 60x60 ซม. เกรด AAA</span>
                    </li>
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>ห้องนอน:</strong> ลามิเนต 12 มม. หรือ SPC</span>
                    </li>
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>ห้องน้ำ:</strong> เซรามิกกันลื่น 30x30 ซม.</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            ...
            <div class="p-6">
                <ul class="space-y-3">
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>วงกบ:</strong> อลูมิเนียมอบขาว/ดำ หนา 1.2 มม.</span>
                    </li>
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>กระจก:</strong> เขียวตัดแสง ลดความร้อน</span>
                    </li>
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>ภายใน:</strong> UPVC/WPC กันน้ำกันปลวก</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
            ...
            <div class="p-6">
                <ul class="space-y-3">
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>ไฟฟ้า:</strong> สาย Yazaki ร้อยท่อ, ตู้ Schneider</span>
                    </li>
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>ประปา:</strong> ท่อน้ำไทย/SCG ชั้น 13.5</span>
                    </li>
                    <li class="flex items-start gap-3 text-sm text-gray-600">
                        <span class="w-1.5 h-1.5 rounded-full bg-primary mt-2 flex-shrink-0"></span>
                        <span><strong>สุขภัณฑ์:</strong> Cotto/American Standard</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <!-- Warranty Box -->
    <div class="mt-16 max-w-4xl mx-auto bg-primary rounded-2xl p-8 md:p-10 text-white shadow-2xl relative overflow-hidden">
        ...
        <div class="relative z-10 text-center md:text-left">
            <h3 class="text-2xl font-bold mb-6 pb-2 border-b border-white/20 inline-block">การรับประกันคุณภาพ</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white/10 rounded-xl p-4 flex items-center md:flex-col md:items-start gap-4">
                    <div className="text-3xl font-bold text-yellow-400">20 ปี</div>
                    <div className="text-sm md:text-base font-medium">รับประกันโครงสร้าง</div>
                </div>
                <div className="bg-white/10 rounded-xl p-4 flex items-center md:flex-col md:items-start gap-4">
                     <div className="text-3xl font-bold text-yellow-400">5 ปี</div>
                    <div className="text-sm md:text-base font-medium">รับประกันงานหลังคา</div>
                </div>
                 <div className="bg-white/10 rounded-xl p-4 flex items-center md:flex-col md:items-start gap-4">
                     <div className="text-3xl font-bold text-yellow-400">1 ปี</div>
                    <div className="text-sm md:text-base font-medium">รับประกันงานสถาปัตย์</div>
                </div>
            </div>
        </div>
    </div>
