...
<p>เราจะไม่เปิดเผยข้อมูลส่วนบุคคลของท่านแก่บุคคลภายนอกโดยไม่ได้รับความยินยอมจากท่าน เว้นแต่จะเป็นไปตามที่กฎหมายกำหนด</p>`,
  ...
  },
  {
    ...
    <!-- Steps Stack (Single Column Centered) -->
    <div class="max-w-3xl mx-auto space-y-6">
        
        <!-- Step 1 -->
        <div class="bg-white rounded-xl p-6 md:p-8 shadow-lg border border-gray-100 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 flex flex-col md:flex-row items-start md:items-center gap-6">
            <div class="flex-shrink-0 w-16 h-16 bg-primary text-white rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
            ...
            <div class="flex-grow">
                <div class="flex justify-between items-center mb-2">
                    <h3 class="text-xl font-bold text-gray-800">1. สำรวจและวางแผน</h3>
                    <span class="text-4xl font-bold text-gray-100 md:text-5xl absolute right-4 top-2 md:relative md:right-auto md:top-auto">01</span>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 md:p-8 shadow-lg border border-gray-100 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 flex flex-col md:flex-row items-start md:items-center gap-6">
            ...
            <div class="flex-grow">
                <div class="flex justify-between items-center mb-2">
                     <h3 class="text-xl font-bold text-gray-800">2. ทำสัญญาและขออนุญาต</h3>
                     <span class="text-4xl font-bold text-gray-100 md:text-5xl absolute right-4 top-2 md:relative md:right-auto md:top-auto">02</span>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 md:p-8 shadow-lg border border-gray-100 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 flex flex-col md:flex-row items-start md:items-center gap-6">
            <div class="flex-shrink-0 w-16 h-16 bg-primary text-white rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
             ...
             <div class="flex-grow">
                <div class="flex justify-between items-center mb-2">
                    <h3 class="text-xl font-bold text-gray-800">3. งานโครงสร้างและฐานราก</h3>
                    <span class="text-4xl font-bold text-gray-100 md:text-5xl absolute right-4 top-2 md:relative md:right-auto md:top-auto">03</span>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 md:p-8 shadow-lg border border-gray-100 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 flex flex-col md:flex-row items-start md:items-center gap-6">
            <div class="flex-shrink-0 w-16 h-16 bg-primary text-white rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
             ...
             <div class="flex-grow">
                <div class="flex justify-between items-center mb-2">
                    <h3 class="text-xl font-bold text-gray-800">4. งานสถาปัตยกรรม</h3>
                    <span class="text-4xl font-bold text-gray-100 md:text-5xl absolute right-4 top-2 md:relative md:right-auto md:top-auto">04</span>
                </div>
        ...
        <div class="bg-white rounded-xl p-6 md:p-8 shadow-lg border border-gray-100 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 flex flex-col md:flex-row items-start md:items-center gap-6">
            <div class="flex-shrink-0 w-16 h-16 bg-primary text-white rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
             ...
             <div class="flex-grow">
                <div class="flex justify-between items-center mb-2">
                    <h3 class="text-xl font-bold text-gray-800">5. งานระบบและตกแต่ง</h3>
                    <span class="text-4xl font-bold text-gray-100 md:text-5xl absolute right-4 top-2 md:relative md:right-auto md:top-auto">05</span>
                </div>
        ...
        <!-- Step 6 -->
        <div class="bg-gradient-to-br from-primary to-red-800 rounded-xl p-6 md:p-8 shadow-lg shadow-red-100 relative overflow-hidden group hover:-translate-y-1 transition-all duration-300 text-white flex flex-col md:flex-row items-start md:items-center gap-6">
            <div class="flex-shrink-0 w-16 h-16 bg-white text-primary rounded-xl flex items-center justify-center shadow-md group-hover:scale-110 transition-transform">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
            </div>
             <div class="flex-grow relative z-10">
                <div class="flex justify-between items-center mb-2">
                    <h3 class="text-xl font-bold text-white">6. ตรวจสอบและส่งมอบ</h3>
                    <span class="text-4xl font-bold text-white/20 md:text-5xl absolute right-4 top-2 md:relative md:right-auto md:top-auto">06</span>
                </div>
  ...
  },
  {
    ...
    <div class="max-w-4xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Structural -->
            <div class="bg-white p-8 rounded-xl shadow-md border border-gray-100 hover:shadow-xl hover:border-primary/30 transition-all group">
                <div class="flex items-center gap-4 mb-6 pb-4 border-b border-gray-100">
                    <div class="w-14 h-14 rounded-lg bg-red-50 text-primary flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h6m-6 4h6m-6 4h6" /></svg>
                    </div>
                    <h3 class="text-xl font-bold text-gray-800">งานโครงสร้าง</h3>
                </div>
                <ul class="space-y-4 text-gray-600">
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>เสาเข็ม:</strong> ได้มาตรฐานวิศวกรรม ตอกจนถึงชั้นดินดาน</span></li>
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>คอนกรีต:</strong> CPAC หรือ Namheng 240 KSC แข็งแรง ทนทาน</span></li>
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>เหล็กเส้น:</strong> เหล็กข้ออ้อยมาตรฐาน มอก. โรงใหญ่ เต็มน้ำหนัก</span></li>
                </ul>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-md border border-gray-100 hover:shadow-xl hover:border-primary/30 transition-all group">
                <div class="flex items-center gap-4 mb-6 pb-4 border-b border-gray-100">
                    ...
                    <h3 class="text-xl font-bold text-gray-800">งานหลังคา</h3>
                </div>
                <ul class="space-y-4 text-gray-600">
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>โครงหลังคา:</strong> โครงถักสำเร็จรูป หรือเหล็กรูปพรรณทาสีกันสนิม 2 รอบ</span></li>
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>กระเบื้อง:</strong> SCG รุ่น Prestige หรือ Excella สวยงาม ไม่รั่วซึม</span></li>
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>ฉนวนกันความร้อน:</strong> ติดตั้งแผ่นสะท้อนความร้อนใต้หลังคา</span></li>
                </ul>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-md border border-gray-100 hover:shadow-xl hover:border-primary/30 transition-all group">
                <div class="flex items-center gap-4 mb-6 pb-4 border-b border-gray-100">
                    ...
                    <h3 class="text-xl font-bold text-gray-800">งานผนัง</h3>
                </div>
                <ul class="space-y-4 text-gray-600">
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>อิฐ:</strong> อิฐมวลเบา Q-CON เกรด G4 บ้านเย็นและเงียบ</span></li>
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>งานฉาบ:</strong> ปูนฉาบสำเร็จรูป เสริมลวดกรงไก่ป้องกันรอยร้าว</span></li>
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>สีทาบ้าน:</strong> TOA 4 Seasons หรือ Supershield เกรดพรีเมียม</span></li>
                </ul>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-md border border-gray-100 hover:shadow-xl hover:border-primary/30 transition-all group">
                <div class="flex items-center gap-4 mb-6 pb-4 border-b border-gray-100">
                    ...
                    <h3 class="text-xl font-bold text-gray-800">งานพื้น</h3>
                </div>
                <ul class="space-y-4 text-gray-600">
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>พื้นชั้นล่าง:</strong> กระเบื้องแกรนิตโต้ 60x60 ซม. เกรด AAA</span></li>
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>พื้นห้องนอน:</strong> ไม้พื้นลามิเนตหนา 12 มม. หรือ กระเบื้องยาง SPC</span></li>
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>ห้องน้ำ:</strong> กระเบื้องเซรามิกกันลื่นขนาด 30x30 ซม.</span></li>
                </ul>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-md border border-gray-100 hover:shadow-xl hover:border-primary/30 transition-all group">
                <div class="flex items-center gap-4 mb-6 pb-4 border-b border-gray-100">
                    ...
                    <h3 class="text-xl font-bold text-gray-800">ประตูหน้าต่าง</h3>
                </div>
                <ul class="space-y-4 text-gray-600">
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>วงกบ:</strong> อลูมิเนียมอบขาว/ดำ Powder Coat หนา 1.2 มม.</span></li>
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>กระจก:</strong> กระจกเขียวตัดแสงช่วยลดความร้อนเข้าสู่ตัวบ้าน</span></li>
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>ประตูภายใน:</strong> ประตู UPVC หรือ WPC กันน้ำและปลวก 100%</span></li>
                </ul>
            </div>
            ...
            <div class="bg-white p-8 rounded-xl shadow-md border border-gray-100 hover:shadow-xl hover:border-primary/30 transition-all group">
                <div class="flex items-center gap-4 mb-6 pb-4 border-b border-gray-100">
                    ...
                    <h3 class="text-xl font-bold text-gray-800">งานระบบ</h3>
                </div>
                <ul class="space-y-4 text-gray-600">
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>ไฟฟ้า:</strong> สายไฟ Yazaki ร้อยท่อร้อยสายไฟ ตู้ไฟ Schneider</span></li>
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>ประปา:</strong> ท่อน้ำไทย หรือ SCG ตราช้าง ชั้นคุณภาพ 13.5</span></li>
                    <li class="flex items-start gap-3"><span class="text-primary mt-0.5 font-bold text-lg">✓</span> <span><strong>สุขภัณฑ์:</strong> Cotto / American Standard / Karat</span></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <!-- Warranty Box -->
    <div className="mt-12 max-w-4xl mx-auto bg-primary rounded-2xl p-8 md:p-12 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10 text-center md:text-left">
            <h3 className="text-2xl md:text-3xl font-bold mb-8 border-b border-white/20 pb-4 inline-block">การรับประกันคุณภาพ</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="flex flex-col items-center md:items-start gap-2">
                    <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center text-2xl font-bold mb-2">20</div>
                    <p className="font-bold text-2xl">20 ปี</p>
                    <p className="text-white/80">รับประกันโครงสร้าง</p>
                </div>
                <div className="flex flex-col items-center md:items-start gap-2">
                     <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center text-2xl font-bold mb-2">5</div>
                    <p className="font-bold text-2xl">5 ปี</p>
                    <p className="text-white/80">รับประกันงานหลังคา</p>
                </div>
                 <div className="flex flex-col items-center md:items-start gap-2">
                     <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center text-2xl font-bold mb-2">1</div>
                    <p className="font-bold text-2xl">1 ปี</p>
                    <p className="text-white/80">รับประกันงานสถาปัตย์</p>
                </div>
            </div>
        </div>
    </div>
  ...
  },
  {
    ...
    <div class="max-w-4xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Service 1 -->
            <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 group border border-gray-100">
                <div class="h-56 bg-gray-50 flex items-center justify-center group-hover:bg-primary/5 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-primary opacity-80 group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h6m-6 4h6m-6 4h6" /></svg>
                </div>
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-bold text-gray-800 mb-4">ตกแต่งภายใน (Interior)</h3>
            ...
            <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 group border border-gray-100">
                ...
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-bold text-gray-800 mb-4">สระว่ายน้ำ (Swimming Pool)</h3>
            ...
            <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 group border border-gray-100">
                ...
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-bold text-gray-800 mb-4">จัดสวน (Landscape)</h3>
            ...
            <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 group border border-gray-100">
                ...
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-bold text-gray-800 mb-4">สมาร์ทโฮม (Smart Home)</h3>
            ...
            <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 group border border-gray-100">
                ...
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-bold text-gray-800 mb-4">รั้วและประตู (Gate & Fence)</h3>
            ...
            <div class="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 group border border-gray-100">
                <div class="h-56 bg-gray-50 flex items-center justify-center group-hover:bg-primary/5 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-primary opacity-80 group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                </div>
                <div class="p-8 text-center">
                    <h3 class="text-2xl font-bold text-gray-800 mb-4">ขอมิเตอร์ (Meters)</h3>
