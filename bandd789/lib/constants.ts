...
<p>เราจะไม่เปิดเผยข้อมูลส่วนบุคคลของท่านแก่บุคคลภายนอกโดยไม่ได้รับความยินยอมจากท่าน เว้นแต่จะเป็นไปตามที่กฎหมายกำหนด</p>`,
  ...
  },
  {
    ...
    content: `<div class="w-full py-8 md:py-12">

    <!-- Process Map Section -->
    <div class="w-full px-4 md:px-12 mx-auto mb-16">
        <div class="text-center mb-10">
            <h2 class="text-2xl md:text-4xl font-bold text-gray-800">ทำให้การสร้างบ้านเป็นเรื่องง่าย</h2>
            <span class="bg-primary text-white px-4 py-1 rounded-full text-sm font-medium inline-block mt-2">คุณแค่ฝันที่เหลือเป็นหน้าที่ของเรา</span>
        </div>
        
        <!-- Simplified Responsive Grid for Steps - Full Width Expansion -->
        <div class="grid grid-cols-2 md:grid-cols-5 gap-y-10 gap-x-6 relative max-w-[1920px] mx-auto">
             
            <!-- Step 1 -->
            <div class="flex flex-col items-center text-center group hover:-translate-y-1 transition-transform duration-300">
                <div class="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-4 shadow-lg text-lg">01</div>
                <div class="bg-red-50 p-4 rounded-full mb-3 shadow-sm group-hover:shadow-md transition-shadow"><svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg></div>
                <p class="font-bold text-gray-800 text-lg">เลือกแบบบ้าน</p>
            </div>

            <!-- Step 2 -->
            <div class="flex flex-col items-center text-center group hover:-translate-y-1 transition-transform duration-300">
                <div class="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-4 shadow-lg text-lg">02</div>
                 <div class="bg-red-50 p-4 rounded-full mb-3 shadow-sm group-hover:shadow-md transition-shadow"><svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l5.447 2.724A1 1 0 0021 16.382V5.618a1 1 0 00-1.447-.894L15 7m-6 13v-3m6 3v-3m0 0V7" /></svg></div>
                <p class="font-bold text-gray-800 text-lg">ชำระเงินจอง<br/>สำรวจที่ดิน</p>
            </div>

            <!-- Step 3 -->
             <div class="flex flex-col items-center text-center group hover:-translate-y-1 transition-transform duration-300">
                <div class="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-4 shadow-lg text-lg">03</div>
                <div class="bg-red-50 p-4 rounded-full mb-3 shadow-sm group-hover:shadow-md transition-shadow"><svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg></div>
                <p class="font-bold text-gray-800 text-lg">เขียนแบบ<br/>ทำสัญญา</p>
            </div>

            <!-- Step 4 -->
             <div class="flex flex-col items-center text-center group hover:-translate-y-1 transition-transform duration-300">
                <div class="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-4 shadow-lg text-lg">04</div>
                <div class="bg-red-50 p-4 rounded-full mb-3 shadow-sm group-hover:shadow-md transition-shadow"><svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg></div>
                <p class="font-bold text-gray-800 text-lg">เตรียมเอกสาร<br/>ยื่นขออนุญาต</p>
            </div>

            <!-- Step 5 -->
             <div class="flex flex-col items-center text-center group hover:-translate-y-1 transition-transform duration-300">
                <div class="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-4 shadow-lg text-lg">05</div>
                <div class="bg-red-50 p-4 rounded-full mb-3 shadow-sm group-hover:shadow-md transition-shadow"><svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg></div>
                <p class="font-bold text-gray-800 text-lg">เริ่มงานก่อสร้าง</p>
            </div>

            <!-- Step 6 -->
             <div class="flex flex-col items-center text-center group hover:-translate-y-1 transition-transform duration-300">
                <div class="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-4 shadow-lg text-lg">10</div>
                <div class="bg-red-50 p-4 rounded-full mb-3 shadow-sm group-hover:shadow-md transition-shadow"><svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg></div>
                <p class="font-bold text-gray-800 text-lg">รับประกัน<br/>บริการหลังขาย</p>
            </div>

            <!-- Step 7 -->
             <div class="flex flex-col items-center text-center group hover:-translate-y-1 transition-transform duration-300">
                <div class="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-4 shadow-lg text-lg">09</div>
                <div class="bg-red-50 p-4 rounded-full mb-3 shadow-sm group-hover:shadow-md transition-shadow"><svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" /></svg></div>
                <p class="font-bold text-gray-800 text-lg">ส่งมอบบ้าน</p>
            </div>

            <!-- Step 8 -->
             <div class="flex flex-col items-center text-center group hover:-translate-y-1 transition-transform duration-300">
                <div class="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-4 shadow-lg text-lg">08</div>
                <div class="bg-red-50 p-4 rounded-full mb-3 shadow-sm group-hover:shadow-md transition-shadow"><svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" /></svg></div>
                <p class="font-bold text-gray-800 text-lg">บริการขอเลขที่บ้าน<br/>และมิเตอร์ถาวร</p>
            </div>

            <!-- Step 9 -->
             <div class="flex flex-col items-center text-center group hover:-translate-y-1 transition-transform duration-300">
                <div class="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-4 shadow-lg text-lg">07</div>
                <div class="bg-red-50 p-4 rounded-full mb-3 shadow-sm group-hover:shadow-md transition-shadow"><svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" /></svg></div>
                <p class="font-bold text-gray-800 text-lg">ชำระเงินงวดงาน<br/>ตามสัญญา</p>
            </div>
            
            <!-- Step 10 -->
             <div class="flex flex-col items-center text-center group hover:-translate-y-1 transition-transform duration-300">
                <div class="w-12 h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold mb-4 shadow-lg text-lg">06</div>
                <div class="bg-red-50 p-4 rounded-full mb-3 shadow-sm group-hover:shadow-md transition-shadow"><svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg></div>
                <p class="font-bold text-gray-800 text-lg">ขอมิเตอร์<br/>น้ำ-ไฟ ชั่วคราว</p>
            </div>
        </div>
    </div>

    <!-- Title Banner - Full Width -->
    <div class="w-full px-4 md:px-12 mb-12">
        <div class="bg-primary text-white text-center py-8 md:py-10 rounded-lg shadow-xl relative overflow-hidden w-full">
            <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-red-900 to-transparent opacity-40"></div>
            <h2 class="text-3xl md:text-5xl font-bold relative z-10 drop-shadow-lg">ขั้นตอนการปลูกสร้างบ้าน</h2>
            <p class="text-red-100 mt-3 relative z-10 text-lg md:text-xl font-light">DDHOUSE บริการเหนือระดับ สร้างบ้านคุณภาพ</p>
        </div>
    </div>

    <!-- Quote Section -->
    <div class="text-center mb-12 px-4">
        <p class="text-gray-500 text-xl">ด้วยการให้บริการครบวงจรแบบ</p>
        <div class="flex items-center justify-center gap-6 my-6">
             <svg class="w-10 h-10 text-primary opacity-50 transform rotate-180" fill="currentColor" viewBox="0 0 24 24"><path d="M14.017 21L14.017 18C14.017 16.054 15.825 14.618 17.317 14.757C17.463 13.027 15.545 11.337 13.513 10.571L13.513 6.627C13.513 3.483 16.419 1.00001 19.639 1.00001L20.529 1.00001C21.81 1.00001 22.952 1.99801 23.008 3.32801L23.008 21L14.017 21ZM5.002 21L5.002 18C5.002 16.054 6.828 14.618 8.321 14.757C8.467 13.027 6.55 11.337 4.518 10.571L4.518 6.627C4.518 3.483 7.424 1.00001 10.644 1.00001L11.534 1.00001C12.815 1.00001 13.957 1.99801 14.013 3.32801L14.013 21L5.002 21Z"></path></svg>
             <h3 class="text-4xl md:text-5xl font-bold text-gray-800 tracking-tight">One Stop Service</h3>
             <svg class="w-10 h-10 text-primary opacity-50" fill="currentColor" viewBox="0 0 24 24"><path d="M14.017 21L14.017 18C14.017 16.054 15.825 14.618 17.317 14.757C17.463 13.027 15.545 11.337 13.513 10.571L13.513 6.627C13.513 3.483 16.419 1.00001 19.639 1.00001L20.529 1.00001C21.81 1.00001 22.952 1.99801 23.008 3.32801L23.008 21L14.017 21ZM5.002 21L5.002 18C5.002 16.054 6.828 14.618 8.321 14.757C8.467 13.027 6.55 11.337 4.518 10.571L4.518 6.627C4.518 3.483 7.424 1.00001 10.644 1.00001L11.534 1.00001C12.815 1.00001 13.957 1.99801 14.013 3.32801L14.013 21L5.002 21Z"></path></svg>
        </div>
        <p class="text-xl font-medium text-gray-600">ทำให้การสร้างบ้านของคุณเป็นเรื่องง่าย</p>
    </div>

    <!-- Detail Sections (Accordion Style) - Full Width Area -->
    <div class="w-full px-4 md:px-12 mx-auto space-y-6 max-w-[1920px]">
        <!-- Section 1 -->
        <details class="group bg-white rounded-xl shadow-sm border border-gray-200 open:shadow-md transition-all duration-300 open:bg-red-50/30" open>
            <summary class="flex items-center justify-between cursor-pointer p-6 md:p-8 list-none">
                <h3 class="text-2xl font-bold text-primary">เตรียมความพร้อมก่อนปลูกสร้าง</h3>
                <span class="transition-transform duration-300 group-open:rotate-180 text-primary p-2 bg-red-50 rounded-full">
            ...
            <div class="px-6 pb-8 md:px-8 text-gray-600 leading-relaxed animate-fade-in text-lg">
                <p>เลือกแบบบ้านมาตรฐาน พร้อมปรับฟังก์ชัน บริการแนะนำสินเชื่อกู้ สำรวจที่ดิน ทำสัญญาปลูกสร้าง</p>
            </div>
        </details>

        <!-- Section 2 -->
        <details class="group bg-white rounded-xl shadow-sm border border-gray-200 open:shadow-md transition-all duration-300 open:bg-red-50/30">
            <summary class="flex items-center justify-between cursor-pointer p-6 md:p-8 list-none">
                <h3 class="text-2xl font-bold text-primary">งานเสาเข็ม</h3>
                <span class="transition-transform duration-300 group-open:rotate-180 text-primary p-2 bg-red-50 rounded-full">
                     <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                </span>
            </summary>
            <div class="px-6 pb-8 md:px-8 text-gray-600 leading-relaxed animate-fade-in text-lg">
                <p>สำรวจและวางผังแล้ว จะเข้าสู่ขั้นตอนการตอกเสาเข็มตามที่วางไว้ เสาเข็มมี 2 แบบคือ เสาเข็มตอก หรือ เสาเข็มเจาะ (ขึ้นอยู่กับสภาพหน้างานและวิศวกรกำหนด)</p>
            </div>
        </details>
        ...
        <details class="group bg-white rounded-xl shadow-sm border border-gray-200 open:shadow-md transition-all duration-300 open:bg-red-50/30">
            <summary class="flex items-center justify-between cursor-pointer p-6 md:p-8 list-none">
                <h3 class="text-2xl font-bold text-primary">งานโครงสร้าง</h3>
                <span class="transition-transform duration-300 group-open:rotate-180 text-primary p-2 bg-red-50 rounded-full">
                     <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                </span>
            </summary>
            <div class="px-6 pb-8 md:px-8 text-gray-600 leading-relaxed animate-fade-in text-lg">
                <p>ระบบการก่อสร้างกึ่งสำเร็จรูป มาตรฐานวิศวกรรม หล่อโครงสร้าง เสา-คาน จากโรงงานมาประกอบหน้างาน หรือ แบบหล่อในที่ (Cast-in-place) ตามความเหมาะสมของแบบบ้าน</p>
            </div>
        </details>
        ...
        <details class="group bg-white rounded-xl shadow-sm border border-gray-200 open:shadow-md transition-all duration-300 open:bg-red-50/30">
            <summary class="flex items-center justify-between cursor-pointer p-6 md:p-8 list-none">
                <h3 class="text-2xl font-bold text-primary">งานสถาปัตยกรรมและงานระบบ</h3>
                <span class="transition-transform duration-300 group-open:rotate-180 text-primary p-2 bg-red-50 rounded-full">
                     <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                </span>
            </summary>
            <div class="px-6 pb-8 md:px-8 text-gray-600 leading-relaxed animate-fade-in text-lg">
                <p>เมื่อโครงสร้างเสร็จเรียบร้อย จะเข้าสู่กลุ่มงานสถาปัตยกรรม งานระบบไฟฟ้า-ประปา และ งานระบบสุขาภิบาล ก่อฉาบ ปูกระเบื้อง และทาสี</p>
            </div>
        </details>
        ...
        <details class="group bg-white rounded-xl shadow-sm border border-gray-200 open:shadow-md transition-all duration-300 open:bg-red-50/30">
            <summary class="flex items-center justify-between cursor-pointer p-6 md:p-8 list-none">
                <h3 class="text-2xl font-bold text-primary">การเก็บงานพร้อมส่งมอบบ้าน</h3>
                <span class="transition-transform duration-300 group-open:rotate-180 text-primary p-2 bg-red-50 rounded-full">
                     <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>
                </span>
            </summary>
            <div class="px-6 pb-8 md:px-8 text-gray-600 leading-relaxed animate-fade-in text-lg">
                <p>บ้านทุกหลังต้องผ่านการตรวจสอบคุณภาพ (QC) เพื่อเตรียมส่งมอบบ้าน พร้อมการรับประกันและบริการหลังการส่งมอบบ้าน (After Sales Service)</p>
            </div>
        </details>
    </div>
</div>`,
  ...
  },
  {
    ...
    content: `<div class="w-full py-12">
    <div class="text-center w-full px-4 mb-16">
        <h2 class="text-3xl md:text-5xl font-bold text-primary mb-6">คัดสรรสิ่งที่ดีที่สุดเพื่อบ้านคุณ</h2>
        <p class="text-xl text-gray-600">มาตรฐานวัสดุเกรดพรีเมียม มั่นใจได้ในความแข็งแรง ทนทาน และสวยงาม</p>
    </div>

    <!-- Full Width Grid Container -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-10 w-full px-4 md:px-12 lg:px-16 max-w-[1920px] mx-auto">
        <!-- Card 1: Structural -->
        <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 group flex flex-col">
            <div class="bg-gray-50 p-8 border-b border-gray-100 flex items-center gap-5 group-hover:bg-primary/5 transition-colors">
                <div class="p-4 bg-white rounded-xl shadow-sm text-primary">
                ...
                <h3 class="font-bold text-gray-800 text-2xl">งานโครงสร้าง</h3>
            </div>
            <div class="p-8 flex-grow">
                <ul class="space-y-6">
                    <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>เสาเข็ม:</strong> มาตรฐานวิศวกรรม ตอกถึงชั้นดินดาน มั่นคงแข็งแรง</span>
                    </li>
                    <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>คอนกรีต:</strong> CPAC/Namheng 240 KSC รับกำลังอัดสูง</span>
                    </li>
                    <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>เหล็กเส้น:</strong> เหล็กข้ออ้อย มอก. โรงใหญ่ เต็มน้ำหนัก</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 group flex flex-col">
            <div class="bg-gray-50 p-8 border-b border-gray-100 flex items-center gap-5 group-hover:bg-primary/5 transition-colors">
                ...
                <h3 class="font-bold text-gray-800 text-2xl">งานหลังคา</h3>
            </div>
            <div class="p-8 flex-grow">
                <ul class="space-y-6">
                    <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>โครงหลังคา:</strong> โครงถักสำเร็จรูป/เหล็กกันสนิม ปลอดสนิมตลอดอายุการใช้งาน</span>
                    </li>
                    <li class="flex items-start gap-4 text-base text-gray-700">
                         <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>กระเบื้อง:</strong> SCG รุ่น Prestige/Excella สีสวยทนนาน</span>
                    </li>
                     <li class="flex items-start gap-4 text-base text-gray-700">
                         <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>ฉนวน:</strong> แผ่นสะท้อนความร้อนใต้หลังคา เย็นสบาย</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 group flex flex-col">
            <div class="bg-gray-50 p-8 border-b border-gray-100 flex items-center gap-5 group-hover:bg-primary/5 transition-colors">
                ...
                <h3 class="font-bold text-gray-800 text-2xl">งานผนัง</h3>
            </div>
            <div class="p-8 flex-grow">
                <ul class="space-y-6">
                    <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>อิฐ:</strong> อิฐมวลเบา Q-CON เกรด G4 กันเสียง กันร้อน</span>
                    </li>
                    <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>งานฉาบ:</strong> ปูนฉาบสำเร็จรูป เสริมลวดกรงไก่ลดการแตกร้าว</span>
                    </li>
                     <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>สี:</strong> TOA 4 Seasons/Supershield เช็ดล้างได้</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 group flex flex-col">
            <div class="bg-gray-50 p-8 border-b border-gray-100 flex items-center gap-5 group-hover:bg-primary/5 transition-colors">
                ...
                <h3 class="font-bold text-gray-800 text-2xl">งานพื้น</h3>
            </div>
            <div class="p-8 flex-grow">
                <ul class="space-y-6">
                    <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>ชั้นล่าง:</strong> แกรนิตโต้ 60x60 ซม. เกรด AAA สวยหรู</span>
                    </li>
                    <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>ห้องนอน:</strong> พื้นไม้ลามิเนต 12 มม. หรือ SPC กันปลวก</span>
                    </li>
                    <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>ห้องน้ำ:</strong> กระเบื้องเซรามิกผิวกันลื่น 30x30 ซม.</span>
                    </li>
                </ul>
            </div>
        </div>

        <!-- Card 5: Doors/Windows -->
        <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 group flex flex-col">
            <div class="bg-gray-50 p-8 border-b border-gray-100 flex items-center gap-5 group-hover:bg-primary/5 transition-colors">
                <div class="p-4 bg-white rounded-xl shadow-sm text-primary">
                ...
                <h3 class="font-bold text-gray-800 text-2xl">ประตูหน้าต่าง</h3>
            </div>
            <div class="p-8 flex-grow">
                <ul class="space-y-6">
                    <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>วงกบ:</strong> อลูมิเนียมอบขาว/ดำ หนา 1.2 มม. มาตรฐาน</span>
                    </li>
                    <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>กระจก:</strong> กระจกเขียวตัดแสง ลดความร้อนเข้าตัวบ้าน</span>
                    </li>
                    <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>ภายใน:</strong> บานประตู UPVC/WPC กันน้ำกันปลวก 100%</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden hover:shadow-2xl transition-all duration-300 group flex flex-col">
            <div class="bg-gray-50 p-8 border-b border-gray-100 flex items-center gap-5 group-hover:bg-primary/5 transition-colors">
                ...
                <h3 class="font-bold text-gray-800 text-2xl">งานระบบ</h3>
            </div>
            <div class="p-8 flex-grow">
                <ul class="space-y-6">
                    <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>ไฟฟ้า:</strong> สายไฟ Yazaki ร้อยท่อฝังผนัง, ตู้ไฟ Schneider</span>
                    </li>
                    <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>ประปา:</strong> ท่อน้ำไทย/SCG ชั้น 13.5 ข้อต่อเกลียวทองเหลือง</span>
                    </li>
                    <li class="flex items-start gap-4 text-base text-gray-700">
                        <span class="flex items-center justify-center w-6 h-6 rounded-full bg-green-100 text-green-600 mt-0.5 flex-shrink-0 text-sm font-bold">✓</span>
                        <span><strong>สุขภัณฑ์:</strong> Cotto/American Standard หรือเทียบเท่า</span>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <!-- Warranty Box - Full Width -->
    <div class="mt-20 w-full px-4 md:px-12 lg:px-16 mx-auto max-w-[1920px]">
        <div class="bg-primary rounded-2xl p-12 text-white shadow-2xl relative overflow-hidden">
            ...
            <div class="relative z-10 text-center md:text-left">
                <div class="flex flex-col md:flex-row items-center md:items-start justify-between mb-10">
                    <div>
                        <h3 class="text-3xl md:text-4xl font-bold mb-3">การรับประกันคุณภาพ</h3>
                        <p class="text-red-100 text-xl">เรามั่นใจในคุณภาพงานก่อสร้าง ด้วยการรับประกันที่คุณวางใจได้</p>
                    </div>
                    <div class="mt-6 md:mt-0 bg-white/10 backdrop-blur-md px-6 py-3 rounded-xl border border-white/20 shadow-lg">
                        <span class="text-lg font-bold">DDHOUSE Warranty</span>
                    </div>
                </div>
                
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="bg-white/10 rounded-2xl p-8 flex flex-col items-center md:items-start hover:bg-white/20 transition-colors border border-white/5">
                        <div class="text-5xl font-bold text-yellow-400 mb-2">20 ปี</div>
                        <div class="text-xl font-semibold">รับประกันโครงสร้าง</div>
                        <p class="text-base text-white/80 mt-2 text-center md:text-left">เสาเข็ม ฐานราก คาน เสา พื้น</p>
                    </div>
                    <div class="bg-white/10 rounded-2xl p-8 flex flex-col items-center md:items-start hover:bg-white/20 transition-colors border border-white/5">
                         <div class="text-5xl font-bold text-yellow-400 mb-2">5 ปี</div>
                        <div class="text-xl font-semibold">รับประกันงานหลังคา</div>
                        <p class="text-base text-white/80 mt-2 text-center md:text-left">การรั่วซึมของหลังคาและดาดฟ้า</p>
                    </div>
                     <div class="bg-white/10 rounded-2xl p-8 flex flex-col items-center md:items-start hover:bg-white/20 transition-colors border border-white/5">
                         <div class="text-5xl font-bold text-yellow-400 mb-2">1 ปี</div>
                        <div class="text-xl font-semibold">รับประกันงานสถาปัตย์</div>
                         <p class="text-base text-white/80 mt-2 text-center md:text-left">งานพื้น ผนัง ฝ้า และสี</p>
                    </div>
                </div>
            </div>
        </div>
  ...
  },
  {
    ...
    content: `<div class="w-full py-12">
    <div class="text-center w-full px-4 mb-16">
        <h2 class="text-3xl md:text-5xl font-bold text-primary mb-6">One Stop Service ครบจบในที่เดียว</h2>
    ...
    <!-- Full Width Grid -->
    <div class="w-full px-4 md:px-12 lg:px-16 mx-auto max-w-[1920px]">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            <!-- Service 1 -->
            <div class="bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 group border border-gray-100 flex flex-col">
                <div class="h-72 bg-gray-50 flex items-center justify-center group-hover:bg-primary/5 transition-colors relative">
                     <div class="absolute top-6 right-6 opacity-10 group-hover:opacity-20 transition-opacity">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-32 w-32 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h6m-6 4h6m-6 4h6" /></svg>
                     </div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-primary opacity-90 group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h6m-6 4h6m-6 4h6" /></svg>
                </div>
                <div class="p-10 text-center flex-grow">
                    <h3 class="text-3xl font-bold text-gray-800 mb-5 group-hover:text-primary transition-colors">ตกแต่งภายใน (Interior)</h3>
                    <p class="text-gray-600 leading-relaxed text-lg">เนรมิตพื้นที่ใช้สอยให้สวยงามลงตัว ด้วยทีมมัณฑนากรมากประสบการณ์ ตอบโจทย์ทุกไลฟ์สไตล์ พร้อมงานบิ้วอินคุณภาพสูง</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 group border border-gray-100 flex flex-col">
                <div class="h-72 bg-gray-50 flex items-center justify-center group-hover:bg-primary/5 transition-colors relative">
                     <div class="absolute top-6 right-6 opacity-10 group-hover:opacity-20 transition-opacity">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-32 w-32 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>
                     </div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-primary opacity-90 group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg>
                </div>
                <div class="p-10 text-center flex-grow">
                    <h3 class="text-3xl font-bold text-gray-800 mb-5 group-hover:text-primary transition-colors">สระว่ายน้ำ (Swimming Pool)</h3>
                    <p class="text-gray-600 leading-relaxed text-lg">บริการออกแบบและก่อสร้างสระว่ายน้ำระบบเกลือ ระบบน้ำล้น พร้อมจากุซซี่และสปา ในราคาที่คุณจับต้องได้</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 group border border-gray-100 flex flex-col">
                 <div class="h-72 bg-gray-50 flex items-center justify-center group-hover:bg-primary/5 transition-colors relative">
                     <div class="absolute top-6 right-6 opacity-10 group-hover:opacity-20 transition-opacity">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-32 w-32 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6H8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9" /></svg>
                     </div>
                ...
                <div class="p-10 text-center flex-grow">
                    <h3 class="text-3xl font-bold text-gray-800 mb-5 group-hover:text-primary transition-colors">จัดสวน (Landscape)</h3>
                    <p class="text-gray-600 leading-relaxed text-lg">เปลี่ยนพื้นที่รอบบ้านให้เป็นสวนสวย ร่มรื่น เพิ่มพื้นที่สีเขียวและมุมพักผ่อนให้คนในครอบครัว ด้วยดีไซน์ที่ทันสมัย</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 group border border-gray-100 flex flex-col">
                 <div class="h-72 bg-gray-50 flex items-center justify-center group-hover:bg-primary/5 transition-colors relative">
                     <div class="absolute top-6 right-6 opacity-10 group-hover:opacity-20 transition-opacity">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-32 w-32 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                     </div>
                ...
                <div class="p-10 text-center flex-grow">
                    <h3 class="text-3xl font-bold text-gray-800 mb-5 group-hover:text-primary transition-colors">สมาร์ทโฮม (Smart Home)</h3>
                    <p class="text-gray-600 leading-relaxed text-lg">ยกระดับความสะดวกสบายและความปลอดภัย ด้วยระบบบ้านอัจฉริยะ ควบคุมไฟ แอร์ และกล้องวงจรปิดผ่านมือถือ</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 group border border-gray-100 flex flex-col">
                ...
                <div class="p-10 text-center flex-grow">
                    <h3 class="text-3xl font-bold text-gray-800 mb-5 group-hover:text-primary transition-colors">รั้วและประตู (Gate & Fence)</h3>
                    <p class="text-gray-600 leading-relaxed text-lg">ออกแบบและติดตั้งรั้วรอบบ้าน ประตูรั้วรีโมท อลูมิเนียมลายไม้ หรือเหล็กดัด สวยงาม ทนทาน เข้ากับตัวบ้าน</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 group border border-gray-100 flex flex-col">
                <div class="h-72 bg-gray-50 flex items-center justify-center group-hover:bg-primary/5 transition-colors relative">
                     <div class="absolute top-6 right-6 opacity-10 group-hover:opacity-20 transition-opacity">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-32 w-32 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                     </div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-24 w-24 text-primary opacity-90 group-hover:scale-110 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                </div>
                <div class="p-10 text-center flex-grow">
                    <h3 class="text-3xl font-bold text-gray-800 mb-5 group-hover:text-primary transition-colors">ขอมิเตอร์ (Meters)</h3>
                    <p class="text-gray-600 leading-relaxed text-lg">บริการยื่นเรื่องขอติดตั้งมิเตอร์ประปาและไฟฟ้าถาวร เดินเรื่องเอกสารราชการให้ครบถ้วน พร้อมใช้งานก่อนเข้าอยู่</p>
                </div>
            </div>
        </div>
    </div>
    
    <div class="mt-24 w-full max-w-[1920px] mx-auto px-4 md:px-12 lg:px-16">
        <div class="bg-gray-50 rounded-3xl p-16 text-center relative overflow-hidden shadow-sm">
            <div class="absolute top-0 left-0 w-full h-3 bg-gradient-to-r from-primary to-secondary"></div>
            <h2 class="text-4xl font-bold text-primary mb-6">สนใจบริการเสริม?</h2>
            <p class="text-gray-600 text-xl max-w-3xl mx-auto mb-10">
                ทีมงานของเราพร้อมให้คำปรึกษาและประเมินราคาสำหรับทุกบริการเสริม เพื่อให้บ้านของคุณสมบูรณ์แบบที่สุด
            </p>
            <a href="/appointment" class="inline-block bg-primary text-white font-bold py-4 px-12 rounded-xl hover:bg-red-700 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 text-lg">ติดต่อสอบถาม</a>
        </div>
    </div>
</div>`,
