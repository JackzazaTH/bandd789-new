...
<p>เราจะไม่เปิดเผยข้อมูลส่วนบุคคลของท่านแก่บุคคลภายนอกโดยไม่ได้รับความยินยอมจากท่าน เว้นแต่จะเป็นไปตามที่กฎหมายกำหนด</p>`,
  ...
  },
  {
    ...
    slug: 'appointment',
    title: 'ติดต่อเรา',
    content: `<div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
    <div>
        <h3 class="text-xl font-bold text-gray-800 mb-4">สำนักงานใหญ่</h3>
        ...
        <div class="space-y-3">
             <div class="flex items-center gap-3 text-gray-700">
                ...
                <span class="font-medium">097 978 7459</span>
            </div>
            <div class="flex items-center gap-3 text-gray-700">
                ...
                <span>contact@ddhouse.co.th</span>
            </div>
             <div class="flex items-center gap-3 text-gray-700">
                ...
                <span>ทำการทุกวัน 09:00 - 18:00 น.</span>
            </div>
        </div>
    </div>
    
    <div class="h-[300px] bg-gray-200 rounded-xl overflow-hidden relative shadow-md">
         <!-- Placeholder Map -->
         <img src="https://picsum.photos/seed/map/800/600" alt="Map" class="w-full h-full object-cover opacity-80 hover:opacity-100 transition-opacity" />
         <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
            <span class="bg-white/90 px-4 py-2 rounded-md shadow-sm font-semibold text-gray-600">Google Maps Placeholder</span>
         </div>
    </div>
</div>`,
