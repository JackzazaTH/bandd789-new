...
const SiteInfoForm: React.FC<SiteInfoFormProps> = ({ siteInfo, onSave }) => {
  ...
  const handleGoogleAdsChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    const { name, value } = e.target;
    setFormData(prev => ({
        ...prev,
        googleAds: {
      ...
      <form onSubmit={handleSubmit}>
        <div className="p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="border-t pt-6">
                 <h3 className="text-lg font-semibold text-gray-800 mb-4">Google Ads & Analytics</h3>
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Google Analytics ID</label>
                        <input type="text" name="analyticsId" value={formData.googleAds.analyticsId} onChange={handleGoogleAdsChange} placeholder="G-XXXXXXXXXX" className={inputClasses} />
                    </div>
                    <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">Google Ads Conversion ID</label>
                        <input type="text" name="adsConversionId" value={formData.googleAds.adsConversionId} onChange={handleGoogleAdsChange} placeholder="AW-XXXXXXXXXX" className={inputClasses} />
                    </div>
                 </div>
            </div>
