    ...
    <>
      <header 
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-in-out ${
            ...
            : 'bg-white/50 backdrop-blur-sm py-4 shadow-sm'
        }`}
      >
                  ...
                  {navItems.map(item =>
                      item.subItems ? (
                          <div key={item.name} className="relative group">
                              ...
                              <div className="absolute top-full left-1/2 -translate-x-1/2 w-max bg-white/95 backdrop-blur-lg shadow-xl rounded-lg p-2 pt-3 hidden group-hover:block ring-1 ring-black/5 z-10 animate-fade-in-up origin-top">
