...
type ActiveTab = 'homes' | 'portfolio' | 'banners' | 'articles' | 'pages' | 'promos' | 'testimonials' | 'notifications' | 'popup' | 'siteSettings' |'leads';
type FormState = 
  | { type: 'none' }
    ...
    <div className="bg-white p-8 rounded-xl shadow-2xl">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-primary">Admin Dashboard</h1>
         {activeTab !== 'popup' && activeTab !== 'siteSettings' && (
            <button
            onClick={() => {
      ...
      <div className="border-b border-gray-200 mb-6 overflow-x-auto">
        <nav className="-mb-px flex space-x-8" aria-label="Tabs">
          ...
          <button onClick={() => setActiveTab('siteSettings')} className={`${activeTab === 'siteSettings' ? 'border-primary text-primary' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors duration-200`}>Site Settings</button>
