...
import { FacebookIcon, LineIcon, YouTubeIcon, TiktokIcon, WhatsAppIcon } from './Icon';
  ...
  const SocialLinksSection = () => (
      <div className="w-full bg-white py-16 border-t border-gray-100">
          <div className="container mx-auto px-4 max-w-4xl text-center">
              <h2 className="text-3xl font-bold text-gray-800 mb-10">ติดตามข่าวสารและโปรโมชั่น</h2>
              <div className="flex flex-wrap justify-center gap-8 md:gap-12">
                  {siteInfo.socials.facebook && (
                    <a href={siteInfo.socials.facebook} target="_blank" rel="noreferrer" className="flex flex-col items-center gap-3 group">
                        <div className="w-16 h-16 bg-[#1877F2] rounded-full flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300 ring-4 ring-transparent group-hover:ring-blue-50">
                            <FacebookIcon className="w-8 h-8" />
                        </div>
                        <span className="font-bold text-gray-600 group-hover:text-[#1877F2] transition-colors">Facebook</span>
                    </a>
                  )}
                  
                  {siteInfo.socials.line && (
                    <a href={siteInfo.socials.line} target="_blank" rel="noreferrer" className="flex flex-col items-center gap-3 group">
                        <div className="w-16 h-16 bg-[#00C300] rounded-full flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300 ring-4 ring-transparent group-hover:ring-green-50">
                            <LineIcon className="w-8 h-8" />
                        </div>
                        <span className="font-bold text-gray-600 group-hover:text-[#00C300] transition-colors">Line</span>
                    </a>
                  )}

                  {siteInfo.socials.youtube && (
                   <a href={siteInfo.socials.youtube} target="_blank" rel="noreferrer" className="flex flex-col items-center gap-3 group">
                      <div className="w-16 h-16 bg-[#FF0000] rounded-full flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300 ring-4 ring-transparent group-hover:ring-red-50">
                          <YouTubeIcon className="w-8 h-8" />
                      </div>
                      <span className="font-bold text-gray-600 group-hover:text-[#FF0000] transition-colors">YouTube</span>
                  </a>
                  )}

                  {siteInfo.socials.tiktok && (
                   <a href={siteInfo.socials.tiktok} target="_blank" rel="noreferrer" className="flex flex-col items-center gap-3 group">
                      <div className="w-16 h-16 bg-black rounded-full flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300 ring-4 ring-transparent group-hover:ring-gray-200">
                          <TiktokIcon className="w-8 h-8" />
                      </div>
                      <span className="font-bold text-gray-600 group-hover:text-black transition-colors">TikTok</span>
                  </a>
                  )}
                  
                   {siteInfo.socials.whatsapp && (
                   <a href={siteInfo.socials.whatsapp} target="_blank" rel="noreferrer" className="flex flex-col items-center gap-3 group">
                      <div className="w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300 ring-4 ring-transparent group-hover:ring-green-50">
                          <WhatsAppIcon className="w-8 h-8" />
                      </div>
                      <span className="font-bold text-gray-600 group-hover:text-[#25D366] transition-colors">WhatsApp</span>
                  </a>
                  )}
              </div>
          </div>
