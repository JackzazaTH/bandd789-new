...
const PromotionHomeCard: React.FC<{ home: HomeDesign; onSelect: (id: string) => void; }> = ({ home, onSelect }) => {
    ...
    return (
        <div 
            ...
            className="w-[330px] flex-shrink-0 bg-white rounded-2xl shadow-lg overflow-hidden cursor-pointer snap-start transform transition-transform hover:-translate-y-2"
        >
            <div className="p-4 relative">
                {home.discount_percentage && (
                    <div className="absolute top-0 left-0 bg-gradient-to-r from-orange-500 to-red-600 text-white text-lg font-bold px-6 py-4 rounded-br-2xl flex items-center gap-1 shadow-md">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M10.894 2.553a1 1 0 00-1.789 0l-7 12.25A1 1 0 003 16.5h14a1 1 0 00.894-1.447l-7-12.25z" />
                        </svg>
                        {home.discount_percentage}%
                    </div>
                )}
                <button className="absolute top-4 right-4 w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center hover:bg-gray-300 transition-colors">
            ...
            <div className="container mx-auto">
                ...
                <div className="relative">
                    ...
                    <div 
                        ...
                        // FIX: Changed kebab-case '-ms-overflow-style' to camelCase 'msOverflowStyle' for React styles
