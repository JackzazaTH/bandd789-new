                ...
                <div className="mt-4 space-y-4 animate-fade-in">
                    ...
                    <div className={`grid grid-cols-1 md:grid-cols-2 gap-4 transition-opacity ${formData.promotion_enabled ? 'opacity-100' : 'opacity-50 pointer-events-none'}`}>
                        <div>
                            ...
                            <input type="number" name="discount_percentage" value={formData.discount_percentage} onChange={handleChange} placeholder="e.g. 22" className={inputClasses} />
                        </div>
                        <div>
                        ...
                        <div className="md:col-span-2 border-t pt-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <input type="number" name="price_popular_original" value={formData.price_popular_original} onChange={handleChange} placeholder="Original Price" className={inputClasses} />
                                <input type="number" name="price_popular_discounted" value={formData.price_popular_discounted} onChange={handleChange} placeholder="Discounted Price" className={inputClasses} />
                            </div>
                        </div>
                        ...
                        <div className="md:col-span-2 border-t pt-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <input type="number" name="price_signature_original" value={formData.price_signature_original} onChange={handleChange} placeholder="Original Price" className={inputClasses} />
                                <input type="number" name="price_signature_discounted" value={formData.price_signature_discounted} onChange={handleChange} placeholder="Discounted Price" className={inputClasses} />
                            </div>
                        </div>
                    </div>
                </div>
